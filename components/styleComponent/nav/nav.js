"use client";
import CerrarSession from "@/components/Auth/CerrarSession";
                ...
                <li className="flex justify-around gap-x-10">
                  ...
                  >
                    <div>
                      Editar Catalogo
                      {client && (
                        <span className="bg-orange-300 ml-10 w-10 h-10 flex items-center justify-center rounded-full text-black p-1  absolute">
                          {items.length}
                        </span>
                      )}
                    </div>
